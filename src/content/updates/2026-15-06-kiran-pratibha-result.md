...
content:
  - |
    <div>
    We are pleased to announce <b>Kiran Pratibha Scholarship 2026</b> results. This scholarship is a recognition of your outstanding academic achievements, dedication, and potential to excel in your future endeavors.<br>
  ...
  - |
    <div style="padding-top: 24px;">
    <b>Our best wishes are with you!</b> 
    </div>
 
  - |
    <div style="padding-top: 24px;">
    Welcome to the Kiran Foundation  family: 
    <ol>
    <li>Saumya Pal</li>
  ...
  - |
   <div style="padding-top: 24px;">
    Following candidates are in the waitlist: 
    <ol>
    <li>Yash Pandey</li>
    <li>Harshit Mani Tripathi</li>
    <li>Mayank Vats</li>
    <li>Yuvika M. D.</li>
    <li>Vighnesh Venkatesh Naik</li>
    <li>Ankita</li>
    <li>Mahi Kumari</li>
    <li>Saniya Soni</li>
    <li>Harshita Kriplani</li>
    </ol>
    </div>
  - |
  ...
  - |
    <div style="padding-top: 24px;">
    <b>Please note that for some of you home verification is still pending. If your home verification is not yet done. Your selection is subjected to succesful verification.</b> 
    </div>
...
featured_image: /assets/images/posts/kiran-pratibha-2026-results.png
alt: "Kiran Pratibha 2026 Results Announced"
...
more: true
summary: "We are delighted to announce the results of Kiran Pratibha 2026. Congratulations to all the participants for their outstanding performances."
link: "/update/2026-15-06-kiran-pratibha-result/"
---